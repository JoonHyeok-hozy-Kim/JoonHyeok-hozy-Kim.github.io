        ...
        - $z = (z_{\text{noise}}, z_{\text{latent}})$.
          - where
            ...
            - $z_{\text{latent}}$ : interpretable latent code
              ...
              - e.g.) From Info GAN   
                ![](assets/img/blog/250908_style_gan/images/info_gan_001.png)
...
{% include figure.liquid path="assets/img/blog/250908_style_gan/images/style_gan_003.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid path="assets/img/blog/250908_style_gan/images/style_gan_001.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid path="assets/img/blog/250908_style_gan/images/style_gan_002.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
- Experiment)
  - Depending on the position of the crossover point we can transfer styles corresponding to
    ...
    {% include figure.liquid path="assets/img/blog/250908_style_gan/images/style_gan_004.png" class="img-fluid rounded z-depth-1" zoomable=true %} 
...
{% include figure.liquid path="assets/img/blog/250908_style_gan/images/style_gan_005.png" class="img-fluid rounded z-depth-1" zoomable=true %}
