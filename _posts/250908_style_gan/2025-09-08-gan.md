...
### Algorithm 1)
- Implementation)   
  {% include figure.liquid path="assets/img/blog/250908_style_gan/images/gan_001.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  - Desc.)
    - One iteration
...
{% include figure.liquid path="assets/img/blog/250908_style_gan/images/gan_002.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
- pf.)   
  {% include figure.liquid path="assets/img/blog/250908_style_gan/images/gan_003.png" class="img-fluid rounded z-depth-1" zoomable=true %}
