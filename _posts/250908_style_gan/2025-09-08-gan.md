...
### Algorithm 1)
- Implementation)   
  {% include figure.liquid path="./images/gan_001.png" class="img-fluid rounded z-depth-1" zoomable=true %}
  - Desc.)
    - One iteration
  ...
  - Learning in Steps   
    {% include figure.liquid path="./images/gan_002.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    - Settings)
...
- pf.)   
  {% include figure.liquid path="./images/gan_003.png" class="img-fluid rounded z-depth-1" zoomable=true %}
